...
namespace MAUIBLAZORHYBRID.Data.Migrations
{
    ...
    [Migration("20250730100533_appdbcontextadd")]
    partial class appdbcontextadd
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MAUIBLAZORHYBRID.Data.DTO.DiningSpaceTables", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MAUIBLAZORHYBRID.Data.Data.DiningSpace", b =>
                {
                    ...
                    b.Property<int?>("BranchMasterbranchId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("BranchMasterbranchId");
            ...
            modelBuilder.Entity("MAUIBLAZORHYBRID.Data.Data.DiningSpace", b =>
                {
                    b.HasOne("MAUIBLAZORHYBRID.Data.Data.BranchMaster", null)
                        .WithMany("DiningSpaces")
                        .HasForeignKey("BranchMasterbranchId");
                });
